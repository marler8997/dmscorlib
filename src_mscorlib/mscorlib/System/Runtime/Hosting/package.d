module mscorlib.System.Runtime.Hosting;
...
/* .NET class */ static struct ManifestRunner
{
...
/* .NET class */ static struct ApplicationActivator
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
...
/* .NET class */ static struct ActivationArguments
{
    mixin __d.clrbridge.DotNetObjectMixin!q{mscorlib.System.Security.Policy.EvidenceBase};
    static struct __clrmetadata
    {
        enum typeSpec = __d.clr.TypeSpec(
            "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
    ...
    public static typeof(this) New(mscorlib.System.ApplicationIdentity applicationIdentity, __d.clrbridge.UnsupportedType!q{System.String[]} activationData)
    {
        enum __method_spec__ = __d.clrbridge.ConstructorSpec(__clrmetadata.typeSpec,
            /* parameter types */ [
                    /* param 'applicationIdentity' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
                        "System.ApplicationIdentity"),
                    /* param 'activationData' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
                        "System.String[]"),
                ]);
        const __method__ = __d.globalClrBridge.getConstructor!__method_spec__();
    ...
    public static typeof(this) New(mscorlib.System.ActivationContext activationData)
    {
        enum __method_spec__ = __d.clrbridge.ConstructorSpec(__clrmetadata.typeSpec,
            /* parameter types */ [
                    /* param 'activationData' */__d.clr.TypeSpec(
    ...
    public static typeof(this) New(mscorlib.System.ActivationContext activationContext, __d.clrbridge.UnsupportedType!q{System.String[]} activationData)
    {
        enum __method_spec__ = __d.clrbridge.ConstructorSpec(__clrmetadata.typeSpec,
            /* parameter types */ [
    ...
    public mscorlib.System.ActivationContext get_ActivationContext() const
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
    ...
    public __d.clrbridge.UnsupportedType!q{System.String[]} get_ActivationData() const
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "get_ActivationData",
            /* generic args */ null,
