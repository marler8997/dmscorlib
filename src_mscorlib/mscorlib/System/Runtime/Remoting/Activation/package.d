module mscorlib.System.Runtime.Remoting.Activation;
...
/* .NET class */ static struct ActivationServices
{
...
/* .NET class */ static struct LocalActivator
{
    mixin __d.clrbridge.DotNetObjectMixin!q{mscorlib.System.Runtime.Remoting.Contexts.ContextAttribute};
    static struct __clrmetadata
    {
        enum typeSpec = __d.clr.TypeSpec(
            "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
    ...
    // skipping virtual method 'get_NextActivator'
    // skipping virtual method 'set_NextActivator'
    // skipping virtual method 'get_Level'
    // skipping virtual method 'Activate'
...
/* .NET class */ static struct ActivationListener
{
...
/* .NET class */ static struct AppDomainLevelActivator
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
...
/* .NET class */ static struct ContextLevelActivator
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
...
/* .NET class */ static struct ConstructionLevelActivator
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
...
/* .NET class */ static struct RemotePropertyHolderAttribute
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
...
/* .NET class */ static struct ActivationAttributeStack
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
...
/* .NET interface */ struct IActivator
{
    // skipping virtual method 'get_NextActivator'
    // skipping virtual method 'set_NextActivator'
    // skipping virtual method 'Activate'
...
/* .NET enum */ static struct ActivatorLevel
{
    static struct __clrmetadata
    {
        enum typeSpec = __d.clr.TypeSpec(
    ...
    enum : typeof(this)
    {
        Construction = typeof(this)(__d.clr.Enum!int(4)),
        Context = typeof(this)(__d.clr.Enum!int(8)),
        AppDomain = typeof(this)(__d.clr.Enum!int(12)),
        Process = typeof(this)(__d.clr.Enum!int(16)),
        Machine = typeof(this)(__d.clr.Enum!int(20)),
    }
    typeof(this) opBinary(string op)(const typeof(this) right) const
    { return typeof(this)(mixin("this.__value__ " ~ op ~ " right.__value__")); }
}
/* .NET interface */ struct IConstructionCallMessage
{
...
/* .NET interface */ struct IConstructionReturnMessage
{
}
/* .NET class */ static struct RemotingXmlConfigFileData
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
    ...
    // skipping virtual method 'GetHashCode'
    // skipping method 'GetType' becuase it is declared in another type 'System.Object'
    /* .NET class */ static struct ChannelEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
    ...
    /* .NET class */ static struct ClientWellKnownEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
    ...
    /* .NET class */ static struct ContextAttributeEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
    ...
    /* .NET class */ static struct InteropXmlElementEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
    ...
    /* .NET class */ static struct CustomErrorsEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
    ...
    /* .NET class */ static struct InteropXmlTypeEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
    ...
    /* .NET class */ static struct LifetimeEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
    ...
    /* .NET class */ static struct PreLoadEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
    ...
    /* .NET class */ static struct ServerWellKnownEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{.RemotingXmlConfigFileData.TypeEntry};
        static struct __clrmetadata
        {
            enum typeSpec = __d.clr.TypeSpec(
                "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
    ...
    /* .NET class */ static struct SinkProviderEntry
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
...
/* .NET class */ static struct RemotingXmlConfigFileParser
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
    ...
    public static .RemotingXmlConfigFileData ParseConfigFile(__d.CString filename)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "ParseConfigFile",
            /* generic args */ null,
...
/* .NET class */ static struct UrlAttribute
{
    mixin __d.clrbridge.DotNetObjectMixin!q{mscorlib.System.Runtime.Remoting.Contexts.ContextAttribute};
    static struct __clrmetadata
    {
    ...
    public static typeof(this) New(__d.CString callsiteURL)
    {
        enum __method_spec__ = __d.clrbridge.ConstructorSpec(__clrmetadata.typeSpec,
            /* parameter types */ [
                    /* param 'callsiteURL' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
                        "System.String"),
                ]);
        const __method__ = __d.globalClrBridge.getConstructor!__method_spec__();
        scope (exit) __d.globalClrBridge.release(__method__);
        auto  __param0__ = __d.globalClrBridge.box!"String"(callsiteURL); // actual type is System.String
        scope (exit) __d.globalClrBridge.release(__param0__);
        __d.ObjectArray __param_values__ = __d.globalClrBridge.makeObjectArray(
             __param0__
        );
    ...
    // skipping virtual method 'IsContextOK'
    // skipping virtual method 'GetPropertiesForNewContext'
    public __d.CString get_UrlValue() const
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "get_UrlValue",
            /* generic args */ null,
