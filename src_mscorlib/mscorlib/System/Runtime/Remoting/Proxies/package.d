module mscorlib.System.Runtime.Remoting.Proxies;
...
/* .NET class */ static struct ProxyAttribute
{
    ...
    // skipping virtual method 'CreateProxy'
...
/* .NET enum */ static struct CallType
{
    static struct __clrmetadata
    {
        enum typeSpec = __d.clr.TypeSpec(
    ...
    enum : typeof(this)
    {
        InvalidCall = typeof(this)(__d.clr.Enum!int(0)),
        MethodCall = typeof(this)(__d.clr.Enum!int(1)),
        ConstructorCall = typeof(this)(__d.clr.Enum!int(2)),
    }
    typeof(this) opBinary(string op)(const typeof(this) right) const
    { return typeof(this)(mixin("this.__value__ " ~ op ~ " right.__value__")); }
}
/* .NET enum */ static struct RealProxyFlags
{
    static struct __clrmetadata
    {
        enum typeSpec = __d.clr.TypeSpec(
    ...
    enum : typeof(this)
    {
        ...
        RemotingProxy = typeof(this)(__d.clr.Enum!int(1)),
        Initialized = typeof(this)(__d.clr.Enum!int(2)),
    }
    typeof(this) opBinary(string op)(const typeof(this) right) const
    { return typeof(this)(mixin("this.__value__ " ~ op ~ " right.__value__")); }
}
/* .NET struct */ static struct MessageData
{
    static struct __clrmetadata
    {
        enum typeSpec = __d.clr.TypeSpec(
...
/* .NET class */ static struct RealProxy
{
    ...
    // skipping virtual method 'GetCOMIUnknown'
    public __d.clrbridge.UnsupportedType!q{System.Runtime.Remoting.Activation.IConstructionReturnMessage} InitializeServerObject(__d.clrbridge.UnsupportedType!q{System.Runtime.Remoting.Activation.IConstructionCallMessage} ctorMsg) const
    {
    ...
    public static void SetStubData(.RealProxy rp, __d.clr.DotNetObject stubData)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "SetStubData",
            /* generic args */ null,
            /* parameter types */ [
                    /* param 'rp' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
                        "System.Runtime.Remoting.Proxies.RealProxy"),
                    /* param 'stubData' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
                        "System.Object"),
                ]);
        assert(__method_spec__.genericTypes.length == 0, "methods with generic args not implemented");
    ...
    public static __d.clr.DotNetObject GetStubData(.RealProxy rp)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "GetStubData",
            /* generic args */ null,
    ...
    public mscorlib.System.Type GetProxiedType() const
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "GetProxiedType",
            /* generic args */ null,
    ...
    // skipping virtual method 'SetCOMIUnknown'
    // skipping virtual method 'SupportsInterface'
    // skipping virtual method 'GetTransparentProxy'
    // skipping virtual method 'ToString'
    // skipping virtual method 'Equals'
    // skipping virtual method 'GetHashCode'
    // skipping method 'GetType' becuase it is declared in another type 'System.Object'
...
/* .NET class */ static struct RemotingProxy
{
    mixin __d.clrbridge.DotNetObjectMixin!q{.RealProxy};
    static struct __clrmetadata
    {
        enum typeSpec = __d.clr.TypeSpec(
            "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
    ...
    public static typeof(this) New(mscorlib.System.Type serverType)
    {
        enum __method_spec__ = __d.clrbridge.ConstructorSpec(__clrmetadata.typeSpec,
            /* parameter types */ [
                    /* param 'serverType' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
                        "System.Type"),
                ]);
        const __method__ = __d.globalClrBridge.getConstructor!__method_spec__();
    ...
    // skipping method 'InitializeServerObject' becuase it is declared in another type 'System.Runtime.Remoting.Proxies.RealProxy'
    // skipping method 'GetProxiedType' becuase it is declared in another type 'System.Runtime.Remoting.Proxies.RealProxy'
    // skipping virtual method 'CreateObjRef'
    // skipping virtual method 'GetObjectData'
    // skipping virtual method 'SupportsInterface'
    // skipping virtual method 'GetTransparentProxy'
...
/* .NET class */ static struct AgileAsyncWorkerItem
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
    ...
    public static typeof(this) New(__d.clrbridge.UnsupportedType!q{System.Runtime.Remoting.Messaging.IMethodCallMessage} message, mscorlib.System.Runtime.Remoting.Messaging.AsyncResult ar, __d.clr.DotNetObject target)
    {
        enum __method_spec__ = __d.clrbridge.ConstructorSpec(__clrmetadata.typeSpec,
            /* parameter types */ [
    ...
    public static void ThreadPoolCallBack(__d.clr.DotNetObject o)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "ThreadPoolCallBack",
            /* generic args */ null,
