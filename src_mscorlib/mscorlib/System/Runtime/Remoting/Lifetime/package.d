module mscorlib.System.Runtime.Remoting.Lifetime;
...
/* .NET class */ static struct ClientSponsor
{
    ...
    public static typeof(this) New(__d.clrbridge.UnsupportedType!q{System.TimeSpan} renewalTime)
    {
        enum __method_spec__ = __d.clrbridge.ConstructorSpec(__clrmetadata.typeSpec,
            /* parameter types */ [
                    /* param 'renewalTime' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
                        "System.TimeSpan"),
                ]);
        const __method__ = __d.globalClrBridge.getConstructor!__method_spec__();
        scope (exit) __d.globalClrBridge.release(__method__);
        auto  __param0__ = __d.globalClrBridge.box!"Object"(renewalTime); // actual type is System.TimeSpan
    ...
    public __d.clrbridge.UnsupportedType!q{System.TimeSpan} get_RenewalTime() const
    {
    ...
    public void set_RenewalTime(__d.clrbridge.UnsupportedType!q{System.TimeSpan} value) const
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "set_RenewalTime",
            /* generic args */ null,
    ...
    public bool Register(mscorlib.System.MarshalByRefObject obj) const
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "Register",
            /* generic args */ null,
    ...
    public void Unregister(mscorlib.System.MarshalByRefObject obj) const
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "Unregister",
            /* generic args */ null,
    ...
    // skipping virtual method 'Renewal'
...
/* .NET interface */ struct ILease
{
    // skipping virtual method 'Register'
    // skipping virtual method 'Register'
    // skipping virtual method 'Unregister'
    // skipping virtual method 'Renew'
    // skipping virtual method 'get_RenewOnCallTime'
    // skipping virtual method 'set_RenewOnCallTime'
    // skipping virtual method 'get_SponsorshipTimeout'
    // skipping virtual method 'set_SponsorshipTimeout'
    // skipping virtual method 'get_InitialLeaseTime'
    // skipping virtual method 'set_InitialLeaseTime'
    // skipping virtual method 'get_CurrentLeaseTime'
    // skipping virtual method 'get_CurrentState'
}
/* .NET interface */ struct ISponsor
{
    // skipping virtual method 'Renewal'
}
/* .NET class */ static struct Lease
{
    mixin __d.clrbridge.DotNetObjectMixin!q{mscorlib.System.MarshalByRefObject};
    static struct __clrmetadata
    {
    ...
    // skipping virtual method 'GetHashCode'
    // skipping method 'GetType' becuase it is declared in another type 'System.Object'
    /* .NET delegate */ static struct AsyncRenewal
    {
        // TODO: generate delegate members
    }
    /* .NET enum */ static struct SponsorState
    {
        static struct __clrmetadata
        {
            enum typeSpec = __d.clr.TypeSpec(
        ...
        enum : typeof(this)
        {
            ...
            Waiting = typeof(this)(__d.clr.Enum!int(1)),
            Completed = typeof(this)(__d.clr.Enum!int(2)),
        }
        typeof(this) opBinary(string op)(const typeof(this) right) const
        { return typeof(this)(mixin("this.__value__ " ~ op ~ " right.__value__")); }
    }
    /* .NET class */ static struct SponsorStateInfo
    {
...
/* .NET class */ static struct LeaseSink
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
    ...
    public static typeof(this) New(.Lease lease, __d.clrbridge.UnsupportedType!q{System.Runtime.Remoting.Messaging.IMessageSink} nextSink)
    {
        enum __method_spec__ = __d.clrbridge.ConstructorSpec(__clrmetadata.typeSpec,
            /* parameter types */ [
                    /* param 'lease' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
                        "System.Runtime.Remoting.Lifetime.Lease"),
                    /* param 'nextSink' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
...
/* .NET class */ static struct LeaseManager
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
    ...
    // skipping virtual method 'GetHashCode'
    // skipping method 'GetType' becuase it is declared in another type 'System.Object'
    /* .NET class */ static struct SponsorInfo
    {
        mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
        static struct __clrmetadata
        {
...
/* .NET enum */ static struct LeaseState
{
    static struct __clrmetadata
    {
        enum typeSpec = __d.clr.TypeSpec(
    ...
    enum : typeof(this)
    {
        ...
        Initial = typeof(this)(__d.clr.Enum!int(1)),
        Active = typeof(this)(__d.clr.Enum!int(2)),
        Renewing = typeof(this)(__d.clr.Enum!int(3)),
        Expired = typeof(this)(__d.clr.Enum!int(4)),
    }
    typeof(this) opBinary(string op)(const typeof(this) right) const
    { return typeof(this)(mixin("this.__value__ " ~ op ~ " right.__value__")); }
}
/* .NET class */ static struct LifetimeServices
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
    ...
    public static __d.clrbridge.UnsupportedType!q{System.TimeSpan} get_LeaseTime()
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "get_LeaseTime",
            /* generic args */ null,
    ...
    public static void set_LeaseTime(__d.clrbridge.UnsupportedType!q{System.TimeSpan} value)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "set_LeaseTime",
            /* generic args */ null,
    ...
    public static __d.clrbridge.UnsupportedType!q{System.TimeSpan} get_RenewOnCallTime()
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "get_RenewOnCallTime",
            /* generic args */ null,
    ...
    public static void set_RenewOnCallTime(__d.clrbridge.UnsupportedType!q{System.TimeSpan} value)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "set_RenewOnCallTime",
            /* generic args */ null,
    ...
    public static __d.clrbridge.UnsupportedType!q{System.TimeSpan} get_SponsorshipTimeout()
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
    ...
    public static void set_SponsorshipTimeout(__d.clrbridge.UnsupportedType!q{System.TimeSpan} value)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
    ...
    public static __d.clrbridge.UnsupportedType!q{System.TimeSpan} get_LeaseManagerPollTime()
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
    ...
    public static void set_LeaseManagerPollTime(__d.clrbridge.UnsupportedType!q{System.TimeSpan} value)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
...
/* .NET class */ static struct LeaseLifeTimeServiceProperty
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
