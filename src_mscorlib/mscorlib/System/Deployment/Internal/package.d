module mscorlib.System.Deployment.Internal;
...
/* .NET class */ static struct InternalApplicationIdentityHelper
{
    ...
    public static __d.clr.DotNetObject GetInternalAppId(mscorlib.System.ApplicationIdentity id)
    {
...
/* .NET class */ static struct InternalActivationContextHelper
{
    mixin __d.clrbridge.DotNetObjectMixin!q{__d.clr.DotNetObject};
    static struct __clrmetadata
    {
    ...
    public static __d.clr.DotNetObject GetActivationContextData(mscorlib.System.ActivationContext appInfo)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "GetActivationContextData",
            /* generic args */ null,
            /* parameter types */ [
                    /* param 'appInfo' */__d.clr.TypeSpec(
                        "mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089",
    ...
    public static __d.clr.DotNetObject GetApplicationComponentManifest(mscorlib.System.ActivationContext appInfo)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
    ...
    public static __d.clr.DotNetObject GetDeploymentComponentManifest(mscorlib.System.ActivationContext appInfo)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
    ...
    public static void PrepareForExecution(mscorlib.System.ActivationContext appInfo)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "PrepareForExecution",
            /* generic args */ null,
    ...
    public static bool IsFirstRun(mscorlib.System.ActivationContext appInfo)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
            "IsFirstRun",
            /* generic args */ null,
    ...
    public static __d.clrbridge.UnsupportedType!q{System.Byte[]} GetApplicationManifestBytes(mscorlib.System.ActivationContext appInfo)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
    ...
    public static __d.clrbridge.UnsupportedType!q{System.Byte[]} GetDeploymentManifestBytes(mscorlib.System.ActivationContext appInfo)
    {
        enum __method_spec__ = __d.clrbridge.MethodSpec(__clrmetadata.typeSpec,
